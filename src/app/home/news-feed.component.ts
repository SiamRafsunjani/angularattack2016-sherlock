...
@Component({
  selector:'news-feed',
  template:require('./templates/news-feed.component.html'),
...
export class NewsFeedComponent{
    ...
    getMaxUsed(langArr:any){
      var maxLang=langArr[0];
      var maxCount:any=0;
      langArr.map(function(currentValue:any,index:any,array:any){
